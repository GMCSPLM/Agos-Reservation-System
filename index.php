...
$stmt = $pdo->prepare("SELECT reservation_date, COUNT(*) as count FROM reservations 
...
<header class="hero">
    <div class="hero-content">
        ...
        <a href="book.php" class="btn-hero">Check Available Dates Now</a>
    </div>
</header>
...
<section class="container" style="padding-top: 4rem; padding-bottom: 4rem;">
    ...
    <div style="background: white; padding: 2rem; border-radius: 20px; box-shadow: var(--shadow); text-align: center;">
        ...
        <h3 style="color: var(--primary); margin-bottom: 25px; font-size: 1.5rem;">
        ...
        <div class="calendar-grid">
            ...
            for ($day = 1; $day <= $daysInMonth; $day++) {
                ...
                $count = isset($bookings[$dateStr]) ? $bookings[$dateStr] : 0;
                
                $isFull = ($count >= $totalBranches);
        ...
        <p style="margin-top: 20px; color: #666; font-size: 0.9rem;">
            ...
            <span style="display:inline-block; width:10px; height:10px; background:#ffebee; border:1px solid #ffcdd2; margin-left:15px; margin-right:5px;"></span> Fully Booked
        </p>
    </div>
</section>
